...
void Packet::copy(const Packet& other)
{
    ...
    this->origAddr = other.origAddr;
    this->carryingFile = other.carryingFile;
}
...
void Packet::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->origAddr);
    doParsimPacking(b,this->carryingFile);
}
...
void Packet::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->origAddr);
    doParsimUnpacking(b,this->carryingFile);
}
...
int Packet::getOrigAddr() const
{
    return this->origAddr;
}

void Packet::setOrigAddr(int origAddr)
{
    this->origAddr = origAddr;
}

bool Packet::getCarryingFile() const
{
    return this->carryingFile;
}

void Packet::setCarryingFile(bool carryingFile)
{
...
int PacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='o' && strcmp(fieldName, "origAddr")==0) return base+3;
    if (fieldName[0]=='c' && strcmp(fieldName, "carryingFile")==0) return base+4;
...
std::string PacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return long2string(pp->getOrigAddr());
        case 4: return bool2string(pp->getCarryingFile());
        default: return "";
    }
}
...
bool PacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 3: pp->setOrigAddr(string2long(value)); return true;
        case 4: pp->setCarryingFile(string2bool(value)); return true;
